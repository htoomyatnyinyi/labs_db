...
{
  "location": "Mfdawlamyine",
  "bios": "I'm self Developer"
}
###
...
###
POST http://localhost:8080/submit-resume
Content-Type: application/json

{
  "personalInfo": {
    "name": "Hnin Phyu",
    "email": "hninphyu@gmail.com",
    "phone": "93242342"
  },
  "summary": {
    "null": "[object Object]e"
  },
  "experience": [
    {
      "role": "Sale Professioanl",
      "company": "Micro Lab",
      "duration": "3 years (2010-2022)",
      "description": "lafjwelkfjalkfjklfklwjwlk"
    }
  ],
  "skills": [
    "ff",
